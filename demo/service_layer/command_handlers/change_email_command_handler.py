...
class ChangeEmailCommandHandler(ddd.AbstractCommandHandler[ChangeEmailCommand, str]):
...
class AsyncChangeEmailCommandHandler(ddd.AbstractAsyncCommandHandler[ChangeEmailCommand, str]):
